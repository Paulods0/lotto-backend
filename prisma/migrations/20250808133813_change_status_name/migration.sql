/*
  ...
  - The values [manuntencao] on the enum `TerminalStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."TerminalStatus_new" AS ENUM ('em_campo', 'formacao', 'stock', 'avaria', 'manutencao');
